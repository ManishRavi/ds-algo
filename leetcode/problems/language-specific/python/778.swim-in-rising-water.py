...
class Solution:
    def swimInWater(self, grid: List[List[int]]) -> int:
        ...
        visited_set = set((0, 0))
        # * Stores a pair of grid value, row and col.
        # * Pair -> (grid_value, row, col)
        ...
        while min_heap:
            ...
            for d_row, d_col in DIRECTIONS:
                ...
                # * Store the max value along the path so that we don't lose it and
                # * once we've reached the last position we can return that value.
